...
2. Find the following section:
    ...
    ```
    Change the "server" from "unix:/run/php/php7.4-fpm.sock;" to "unix:/run/php/php8.2-fpm.sock;".
...
2. Find the section that you changed:
    ...
    ```
    Change the "server" from "unix:/run/php/php8.2-fpm.sock;" back to "unix:/run/php/php7.4-fpm.sock;".
    The section should now read like this:
    ```
        upstream php {
            server unix:/run/php/php7.4-fpm.sock;
